A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Set User State
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-set-user-state-data-action-module.git?ref=main"
    action_name        = "Set User State"
